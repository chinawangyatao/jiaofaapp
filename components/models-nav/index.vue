<template>
	<view class="container" v-show="showMask">
		...
		<view class="main" :style="{transform: `translateY(${transY}rpx)`,'transition-timing-function': speed,'height': height,'width':width,'bottom':bottom,'left':left,'border-radius':radius,'background-color':background}" @transitionend="onTransitionend">
			<slot></slot>
		</view>
	</view>
</template>
